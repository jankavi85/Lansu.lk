...
$sql="SELECT category,sub_category,district,district_area,conditionOn,item_avatar,title,description,price,delivery_option,user_name,phone_number FROM biditem INNER JOIN user on biditem.user_id=user.user_id WHERE biditem_id='$id';";
