					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								...
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#mens8">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
							  ...
							  <div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#mens9">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											HOBBY SPORT & KIDS
										</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#mens0">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											EDUCATION
										</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="#mens00">
											<span class="badge pull-right"><i class="fa fa-plus"></i></span>
											ANIMALS
										</a>
									</h4>
					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tshirt" data-toggle="tab">Bidding Items</a></li>
								<li><a href="#blazers" data-toggle="tab">Direct Items</a></li>
							</ul>
						</div>
						<!-- kemal-->
						...
						<!--/category-tab-->
						<!-- janith direct addd ---->
						<div class="tab-pane fade in" id="blazers" >
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
